...
if __name__=="__main__":
    ...
    while (figura < number_of_random_poligons) :
        ...
        #Histograma final areas
        part=particion_vertices(external,intermediate,internal)
        plt.hist(part[1]/part[1].mean()-1, bins=50);
        
        #Histograma final perimetros
        plt.hist(part[2]/part[2].mean()-1, bins=50);
